...
function responsive_read_more() {
    return '<div class="read-more"><a href="' . get_permalink() . '">' . __('Leia mais', 'responsive') . '</a></div><!-- end of .read-more -->';
}
...
function responsive_post_meta_data() {
	printf( __( '<span class="%3$s"> Por: </span>%4$s<span class="%1$s"> em </span>%2$s', 'responsive' ),

...
<div id="footer" class="clearfix footer-border">
        ...
        <div class="grid col-940">
          ...
          <div class="grid col-140 fit">
            <a href="<?php echo home_url('/'); ?>">
              <div class="footer-logo"><img src="<?php bloginfo('template_url'); ?>/images/logo-footer.png"></div>
            </a>
          </div>

    <div class="grid-right col-541">
    ...
    <div class="powered">
        Concebido pela <a href="http://nossoquintal.com/" target="_blank">Quintal</a> e produzido pela <a href="http://cabanacriacao.com" target="_blank">Cabana.</a>
    </div><!-- end .powered -->
</div><!-- end #footer -->
...
<script type="text/javascript">
  jQuery('#categories-2 .cat-item').prepend('»&nbsp;');
  jQuery('#archives-2 li').prepend('»&nbsp;');
</script>
